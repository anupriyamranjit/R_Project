...
predictor_vars <- c("step", "amount", "oldbalanceOrg", "newbalanceOrig", "oldbalanceDest", "newbalanceDest")
formula <- as.formula(paste("isFraud ~", paste(predictor_vars, collapse = "+")))


if (file.exists("savename.hdf5")) {
  
  loaded_model <- load_model_hdf5("savename.hdf5")
...
model %>% save_model_hdf5("./savename.hdf5")
